...
// --------------------------  -------------------------- //
    ...
    extend( Simodal.prototype, EvEmitter.prototype );
    ...
    Simodal.prototype.onSubmit = function(clicked_elem) {
        this.emitEvent('submit', clicked_elem)
    };

    Simodal.prototype.onCancel = function(clicked_elem) {
        this.emitEvent('cancel', clicked_elem)
    };
